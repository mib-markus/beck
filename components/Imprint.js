<div>
  <h1 class="adsimple-321164724">Impressum</h1>
  ...
  <p class="adsimple-321164724">
    <strong>Berufsbezeichnung:</strong> Cloud Solution Architekt & Consulting
  </p>
  <p class="adsimple-321164724">
  ...
  <p style="margin-top:15px;">
    ...
    <a href="https://www.bauenwir.de" target="_blank" rel="follow" title="">
      bauenwir.de
    </a>
  </p>
  ...
  <p>
    ...
    übernehmen, speziell für jene die seitens Dritter bereitgestellt wurden. Als
    Diensteanbieter im Sinne der §§ 8 bis 10 sind wir nicht verpflichtet, die
  ...
  <ul class="adsimple-321164724">
    <li class="adsimple-321164724">Fotograf Mustermann</li>
  </ul>
  ...
  <p>
    ...
    Ihre gewohnte Standardeinstellung. In einigen Browsern hat jedes Cookie eine
    eigene Datei, in anderen wie beispielsweise Firefox sind alle Cookies in
  ...
  <h3 class="adsimple-321164724">Welche Arten von Cookies gibt es?</h3>
  <p>
  ...
  <p>
    ...
    deaktivieren. Zum Beispiel können Sie Cookies von Drittanbietern blockieren,
  ...
  <p>
    ...
    verschieden. Am besten ist es Sie suchen die Anleitung in Google mit dem
  ...
  <h3 class="adsimple-321164724">Wie sieht es mit meinem Datenschutz aus?</h3>
  <p>
    ...
    Website-Besuchers (also von Ihnen) verlangt. Innerhalb der EU-Länder gibt es
  ...
  <p>
    ...
    , dem Request for Comments der Internet Engineering Task Force (IETF) namens
  ...
  <p>
    ...
    Angaben im Rahmen der Übermittlung eines Formulars oder Kommentaren im Blog,
  ...
  <h2 class="adsimple-321164724">Rechte laut Datenschutzgrundverordnung</h2>
  <p>
  ...
  <ul class="adsimple-321164724">
    ...
    <li class="adsimple-321164724">Widerspruchsrecht (Artikel 21 DSGVO)</li>
    <li class="adsimple-321164724">
  ...
  <p>
    ...
    wir den Schutz vertraulicher Daten sicherstellen. Sie erkennen die Benutzung
    dieser Absicherung der Datenübertragung am kleinen Schloßsymbol links oben
    im Browser und der Verwendung des Schemas https (anstatt http) als Teil
  ...
  <p>
    ...
    allen anderen Google-Diensten. Wenn Sie ein Google-Konto haben, brauchen Sie
    keine Sorge haben, dass Ihre Google-Kontodaten, während der Verwendung von
    Google Fonts, an Google übermittelt werden. Google erfasst die Nutzung von
    CSS (Cascading Style Sheets) und der verwendeten Schriftarten und speichert
    diese Daten sicher. Wie die Datenspeicherung genau aussieht, werden wir uns
  ...
  <p>
    ...
    Chrome, Mozilla Firefox, Apple Safari, Opera)  und funktioniert zuverlässig
    auf den meisten modernen mobilen Betriebssystemen, einschließlich Android
    2.2+ und iOS 4.2+ (iPhone, iPad, iPod).
  </p>
  <p>
    Wir verwenden die Google Fonts also, damit wir unser gesamtes Online-Service
    so schön und einheitlich wie möglich darstellen können. Nach dem Art. 6 Abs.
    1 f lit. F DSGVO stellt das bereits ein „berechtigtes Interesse“ an der
    Verarbeitung von personenbezogenen Daten dar. Unter „berechtigtem Interesse“
    versteht man in diesem Fall sowohl rechtliche als auch wirtschaftliche oder
    ideelle Interessen, die vom Rechtssystem anerkannt werden.
  </p>
  <h3 class="adsimple-321164724">
  ...
  <p>
    ...
    ist eine Formatvorlage, über die man einfach und schnell z.B. das Design
    bzw. die Schriftart einer Webseite ändern kann.
  </p>
  <p>
    ...
    Millionen von Webseiten auf die gleichen Schriften verweisen, werden sie
    nach dem ersten Besuch zwischengespeichert und erscheinen sofort auf allen
    anderen später besuchten Webseiten wieder. Manchmal aktualisiert Google
    Schriftdateien, um die Dateigröße zu reduzieren, die Abdeckung von Sprache
    zu erhöhen und das Design zu verbessern.
  </p>
  <h3 class="adsimple-321164724">
  ...
  <p>
    ...
    auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an
    ...
    enthalten. Es ist relativ schwierig (beinahe unmöglich), von Google wirklich
  ...
  <ul class="adsimple-321164724">
    ...
    <li class="adsimple-321164724">das verwendete Betriebssystem</li>
    <li class="adsimple-321164724">
  ...
  <h2 class="adsimple-321164724">Google reCAPTCHA Datenschutzerklärung</h2>
  <p>
    Unser oberstes Ziel ist es, dass unsere Webseite für Sie und für uns
    bestmöglich geschützt und sicher ist. Um das zu gewährleisten, verwenden wir
    Google reCAPTCHA der Firma Google Inc. (1600 Amphitheatre Parkway Mountain
    View, CA 94043, USA). Mit reCAPTCHA können wir feststellen, ob Sie auch
    wirklich ein Mensch aus Fleisch und Blut sind und kein Roboter oder eine
    andere Spam-Software. Unter Spam verstehen wir jede, auf elektronischen Weg,
    unerwünschte Information, die uns ungefragter Weise zukommt. Bei den
    klassischen CAPTCHAS mussten Sie zur Überprüfung meist Text- oder Bildrätsel
    lösen. Mit reCAPTCHA von Google müssen wir Sie meist nicht mit solchen
    Rätseln belästigen. Hier reicht es in den meisten Fällen, wenn Sie einfach
    ein Häkchen setzen und so bestätigen, dass Sie kein Bot sind. Mit der neuen
    Invisible reCAPTCHA Version müssen Sie nicht mal mehr ein Häkchen setzen.
    Wie das genau funktioniert und vor allem welche Daten dafür verwendet
  ...
  <p>
    ...
    Verarbeitung), denn es besteht ein berechtigtes Interesse diese Webseite vor
    Bots und Spam-Software zu schützen.
  </p>
  ...
  <p>
    ...
    von reCAPTCHA werden Daten an Google übermittelt, die Google verwendet, um
    ...
    Sicherheit. Zum Beispiel könnte es ohne reCAPTCHA passieren, dass bei einer
    Registrierung ein Bot möglichst viele E-Mail-Adressen registriert, um im
    Anschluss Foren oder Blogs mit unerwünschten Werbeinhalten „zuzuspamen“. Mit
  ...
  <p>
    ...
    Handlungen auf unserer Webseite auch wirklich von Menschen stammen. Es kann
    also die IP-Adresse und andere Daten, die Google für den reCAPTCHA-Dienst
    benötigt, an Google versendet werden. IP-Adressen werden innerhalb der
    Mitgliedstaaten der EU oder anderer Vertragsstaaten des Abkommens über den
    Europäischen Wirtschaftsraum fast immer zuvor gekürzt, bevor die Daten auf
    einem Server in den USA landen. Die IP-Adresse wird nicht mit anderen Daten
    von Google kombiniert, sofern Sie nicht während der Verwendung von reCAPTCHA
    mit Ihrem Google-Konto angemeldet sind. Zuerst prüft der
    reCAPTCHA-Algorithmus, ob auf Ihrem Browser schon Google-Cookies von anderen
    Google-Diensten (YouTube. Gmail usw.) platziert sind. Anschließend setzt
    reCAPTCHA ein zusätzliches Cookie in Ihrem Browser und erfasst einen
    Schnappschuss Ihres Browserfensters.
  </p>
  <p>
    Die folgende Liste von gesammelten Browser- und Userdaten, hat nicht den
    Anspruch auf Vollständigkeit. Vielmehr sind es Beispiele von Daten, die nach
    unserer Erkenntnis, von Google verarbeitet werden.
  </p>
  <ul class="adsimple-321164724">
    <li class="adsimple-321164724">
      Referrer URL (die Adresse der Seite von der der Besucher kommt)
    </li>
    <li class="adsimple-321164724">IP-Adresse (z.B. 256.123.123.1)</li>
    <li class="adsimple-321164724">
  ...
  <p>
    ...
    <br />
    <strong class="adsimple-321164724">Ablaufzeit:</strong> nach einem Jahr
    <br />
    <strong class="adsimple-321164724">Verwendung:</strong> Dieses Cookie wird
    von der Firma DoubleClick (gehört auch Google) gesetzt, um die Aktionen
    eines Users auf der Webseite im Umgang mit Werbeanzeigen zu registrieren und
    ...
    <p>
      ...
      <br />
      <strong class="adsimple-321164724">Ablaufzeit:</strong> nach einem Monat
      <br />
      <strong class="adsimple-321164724">Verwendung:</strong> Dieses Cookie
      sammelt Statistiken zur Website-Nutzung und misst Conversions. Eine
      Conversion entsteht z.B., wenn ein User zu einem Käufer wird. Das Cookie
      wird auch verwendet, um Usern relevante Werbeanzeigen einzublenden.
      Weiters kann man mit dem Cookie vermeiden, dass ein User dieselbe Anzeige
      mehr als einmal zu Gesicht bekommt.
      <br />
      <strong class="adsimple-321164724">Beispielwert:</strong> 2019-5-14-12
    </p>
    <p>
      <strong class="adsimple-321164724">Name:</strong> ANID
      <br />
      <strong class="adsimple-321164724">Ablaufzeit:</strong> nach 9 Monaten
      <br />
      <strong class="adsimple-321164724">Verwendung:</strong> Viele Infos
    ...
    <p>
      ...
      <br />
      <strong class="adsimple-321164724">Ablaufzeit:</strong> nach 19 Jahren
      <br />
      <strong class="adsimple-321164724">Verwendung:</strong> Das Cookie
    ...
    <p>
      ...
      <br />
      <strong class="adsimple-321164724">Ablaufzeit:</strong> nach 6 Monaten
      <br />
      <strong class="adsimple-321164724">Verwendung:</strong> NID wird von
      ...
      ID, die Google benutzt um persönliche Einstellungen des Users für
    ...
    <p>
      ...
      <br />
      <strong class="adsimple-321164724">Ablaufzeit:</strong> nach 10 Minuten
      <br />
      <strong class="adsimple-321164724">Verwendung:</strong> Sobald Sie das
      „Ich bin kein Roboter“-Häkchen angekreuzt haben, wird dieses Cookie
      ...
      <p>
        ...
        erheben, da Google erfahrungsgemäß die Wahl ihrer Cookies immer wieder
        auch verändert.
      </p>
      <h3 class="adsimple-321164724">
        Wie lange und wo werden die Daten gespeichert?
      ...
      <p>
        ...
        angemeldet sind, werden die Daten zusammengeführt.
        <strong class="adsimple-321164724"> </strong>Dafür gelten die
