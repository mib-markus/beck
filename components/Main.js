          ...
          <p>
            <div>
              ...
              <p class="adsimple-321164724">
                ...
                <a href="mailto:markus.i.beck@outlook.de">
                  markus.i.beck@outlook.de
                </a>
              </p>
              <p class="adsimple-321164724">
              ...
              <p>
                ...
                <a
                  ...
                  rel="noopener"
                >
                  http://ec.europa.eu/odr?tid=321164724
                </a>{" "}
              ...
              <p>
                ...
                sind wir als Diensteanbieter für eigene Informationen, die wir
                zur Nutzung bereitstellen, nach den allgemeinen Gesetzen
              ...
              <p>
                ...
                25.03.2020-321164724) verfasst, um Ihnen gemäß der Vorgaben der{" "}
                <a
                  class="adsimple-321164724"
              ...
              <h3 class="adsimple-321164724">Was genau sind Cookies?</h3>
              <p>
              ...
              <p>
                ...
                Browsers, untergebracht. Ein Cookie besteht aus einem Namen und
                einem Wert. Bei der Definition eines Cookies müssen zusätzlich
              ...
              <ul class="adsimple-321164724">
                <li class="adsimple-321164724">Name: _ga</li>
                <li class="adsimple-321164724">Ablaufzeit: 2 Jahre</li>
                <li class="adsimple-321164724">
                  Verwendung: Unterscheidung der Webseitenbesucher
                </li>
                <li class="adsimple-321164724">
                  Beispielhafter Wert: GA1.2.1326744211.152321164724
                </li>
              </ul>
              ...
              <p>
                <strong class="adsimple-321164724">
              ...
              <h3 class="adsimple-321164724">Wie kann ich Cookies löschen?</h3>
              <p>
              ...
              <p>
                ...
                deaktivieren Chrome&#8221; im Falle eines Chrome Browsers oder
                tauschen das Wort &#8220;Chrome&#8221; gegen den Namen Ihres
              ...
              <p>
                ...
                unterschiedliche Reaktionen auf diese Richtlinien. In
                Deutschland wurden die Cookie-Richtlinien nicht als nationales
                Recht umgesetzt. Stattdessen erfolgte die Umsetzung dieser
                Richtlinie weitgehend in § 15 Abs.3 des Telemediengesetzes
                (TMG).
              </p>
              <p>
              ...
              <p>
                ...
                abseits dieser Webseite &#8211; können wir keine sichere
                Übertragung und den Schutz Ihrer Daten garantieren. Wir
                empfehlen Ihnen, vertrauliche Daten niemals unverschlüsselt per
              ...
              <p>
                ...
                Datenübertragung am kleinen Schloßsymbol links oben im Browser
              ...
              <h3 class="adsimple-321164724">Was sind Google Fonts?</h3>
              <p>
                Google Fonts (früher Google Web Fonts) ist ein interaktives
                Verzeichnis mit mehr als 800 Schriftarten, die die 
                <a
                  class="adsimple-321164724"
              ...
              <p>
                ...
                Software-Lizenzen. Somit können wir sie frei verwenden, ohne
              ...
              <p>
                ...
                Weiteren sind Google Fonts sogenannte sichere Web Fonts.
                ...
                Content Delivery Network (CDN) gibt es mit Google Fonts keine
              ...
              <p>
                ...
                Google Fonts API wurde entwickelt, um die Erfassung, Speicherung
                und Verwendung von Endnutzerdaten auf das zu reduzieren, was für
                eine effiziente Bereitstellung von Schriften nötig ist. API
              ...
              <p>
                ...
                <a
                  ...
                  rel="noopener"
                >
                  https://support.google.com/?hl=de&amp;tid=321164724
                </a>{" "}
              ...
              <p>
                ...
                <a
                  ...
                  rel="noopener"
                >
                  https://developers.google.com/fonts/faq?tid=321164724
                </a>
              ...
              <ul class="adsimple-321164724">
                ...
                <li class="adsimple-321164724">Browser und Browserversion</li>
                <li class="adsimple-321164724">
                ...
                <li class="adsimple-321164724">Datum und Uhrzeit</li>
              </ul>
              ...
              <p>
                ...
                andere Spam-Software. Unter Spam verstehen wir jede, auf
                elektronischen Weg, unerwünschte Information, die uns
                ungefragter Weise zukommt. Bei den klassischen CAPTCHAS mussten
                Sie zur Überprüfung meist Text- oder Bildrätsel lösen. Mit
                reCAPTCHA von Google müssen wir Sie meist nicht mit solchen
                Rätseln belästigen. Hier reicht es in den meisten Fällen, wenn
                Sie einfach ein Häkchen setzen und so bestätigen, dass Sie kein
                Bot sind. Mit der neuen Invisible reCAPTCHA Version müssen Sie
                nicht mal mehr ein Häkchen setzen. Wie das genau funktioniert
                und vor allem welche Daten dafür verwendet werden, erfahren Sie
                im Verlauf dieser Datenschutzerklärung.
              </p>
              <p>
              ...
              <h3 class="adsimple-321164724">Was ist reCAPTCHA?</h3>
              <p>
                ...
                Dienst verwendet, wenn Sie Formulare im Internet ausfüllen. Ein
                Captcha-Dienst ist ein automatischer Turing-Test, der
                sicherstellen soll, dass eine Handlung im Internet von einem
                Menschen und nicht von einem Bot vorgenommen wird. Im
                klassischen Turing-Test (benannt nach dem Informatiker Alan
                Turing) stellt ein Mensch die Unterscheidung zwischen Bot und
                Mensch fest. Bei Captchas übernimmt das auch der Computer bzw.
                ein Softwareprogramm. Klassische Captchas arbeiten mit kleinen
                Aufgaben, die für Menschen leicht zu lösen sind, doch für
                Maschinen erhebliche Schwierigkeiten aufweisen. Bei reCAPTCHA
                ...
                nötig. Bei reCAPTCHA wird ein JavaScript-Element in den
                Quelltext eingebunden und dann läuft das Tool im Hintergrund und
                analysiert Ihr Benutzerverhalten. Aus diesen Useraktionen
              ...
              <p>
                ...
                Benutzerfreundlichkeit für Sie anzubieten. Aus diesem Grund
                verwenden wir Google reCAPTCHA der Firma Google. So können wir
                uns ziemlich sicher sein, dass wir eine „botfreie“ Webseite
                bleiben. Durch die Verwendung von reCAPTCHA werden Daten an
                Google übermittelt, die Google verwendet, um festzustellen, ob
                Sie auch wirklich ein Mensch sind. reCAPTCHA dient also der
                Sicherheit unserer Webseite und in weiterer Folge damit auch
                Ihrer Sicherheit. Zum Beispiel könnte es ohne reCAPTCHA
                passieren, dass bei einer Registrierung ein Bot möglichst viele
                E-Mail-Adressen registriert, um im Anschluss Foren oder Blogs
                mit unerwünschten Werbeinhalten „zuzuspamen“. Mit reCAPTCHA
              ...
              <p>
                ...
                Mitgliedstaaten der EU oder anderer Vertragsstaaten des
                Abkommens über den Europäischen Wirtschaftsraum fast immer zuvor
                gekürzt, bevor die Daten auf einem Server in den USA landen. Die
                IP-Adresse wird nicht mit anderen Daten von Google kombiniert,
                sofern Sie nicht während der Verwendung von reCAPTCHA mit Ihrem
                Google-Konto angemeldet sind. Zuerst prüft der
                reCAPTCHA-Algorithmus, ob auf Ihrem Browser schon Google-Cookies
                von anderen Google-Diensten (YouTube. Gmail usw.) platziert
                sind. Anschließend setzt reCAPTCHA ein zusätzliches Cookie in
                Ihrem Browser und erfasst einen Schnappschuss Ihres
                Browserfensters.
              </p>
              <p>
                Die folgende Liste von gesammelten Browser- und Userdaten, hat
                nicht den Anspruch auf Vollständigkeit. Vielmehr sind es
                Beispiele von Daten, die nach unserer Erkenntnis, von Google
                verarbeitet werden.
              </p>
              <ul class="adsimple-321164724">
                <li class="adsimple-321164724">
                ...
                <li class="adsimple-321164724">
                  Infos über das Betriebssystem (die Software, die den Betrieb
                  Ihres Computers ermöglicht. Bekannte Betriebssysteme sind
                ...
                <li class="adsimple-321164724">
                  Maus- und Keyboardverhalten (jede Aktion, die Sie mit der Maus
                  oder der Tastatur ausführen wird gespeichert)
                </li>
                <li class="adsimple-321164724">
              ...
              <p>
                ...
                analysiert noch bevor Sie auf das Häkchen „Ich bin kein Roboter“
                klicken. Bei der Invisible reCAPTCHA-Version fällt sogar das
                Ankreuzen weg und der ganze Erkennungsprozess läuft im
                Hintergrund ab. Wie viel und welche Daten Google genau
                speichert, erfährt man von Google nicht im Detail.
              </p>
              <p>
                Folgende Cookies werden von reCAPTCHA verwendet: Hierbei
                beziehen wir uns auf die reCAPTCHA Demo-Version von Google unter{" "}
                <a
                  class="adsimple-321164724"
                ...
                Kennung. Hier ist eine Liste an Cookies, die Google reCAPTCHA
                auf der Demo-Version gesetzt hat:
              </p>
              <p>
                <strong class="adsimple-321164724">Name:</strong> IDE
                <br />
                <strong class="adsimple-321164724">Ablaufzeit:</strong> nach
                einem Jahr
                <br />
                <strong class="adsimple-321164724">Verwendung:</strong> Dieses
                Cookie wird von der Firma DoubleClick (gehört auch Google)
                gesetzt, um die Aktionen eines Users auf der Webseite im Umgang
                mit Werbeanzeigen zu registrieren und zu melden. So kann die
                ...
                <br />
                <strong class="adsimple-321164724">Beispielwert:</strong>
                 WqTUmlnmv_qXyi_DGNPLESKnRNrpgXoy1K-pAZtAkMbHI-321164724
                <p>
                  <strong class="adsimple-321164724">Name:</strong> 1P_JAR
                  <br />
                  <strong class="adsimple-321164724">Ablaufzeit:</strong> nach
                  einem Monat
                  <br />
                  <strong class="adsimple-321164724">Verwendung:</strong> Dieses
                  Cookie sammelt Statistiken zur Website-Nutzung und misst
                  Conversions. Eine Conversion entsteht z.B., wenn ein User zu
                  einem Käufer wird. Das Cookie wird auch verwendet, um Usern
                  relevante Werbeanzeigen einzublenden. Weiters kann man mit dem
                  Cookie vermeiden, dass ein User dieselbe Anzeige mehr als
                ...
                <p>
                  <strong class="adsimple-321164724">Name:</strong> ANID
                  <br />
                  <strong class="adsimple-321164724">Ablaufzeit:</strong> nach 9
                  Monaten
                  <br />
                  <strong class="adsimple-321164724">Verwendung:</strong> Viele
                  Infos konnten wir über dieses Cookie nicht in Erfahrung
                  bringen. In der Datenschutzerklärung von Google wird das
                  Cookie im Zusammenhang mit „Werbecookies“ wie z. B.
                  &#8220;DSID&#8221;, &#8220;FLC&#8221;, &#8220;AID&#8221;,
                  &#8220;TAID&#8221; erwähnt. ANID wird unter Domain google.com
                  gespeichert.
                  <br />
                  <strong class="adsimple-321164724">Beispielwert:</strong>
                   U7j1v3dZa3211647240xgZFmiqWppRWKOr
                </p>
                <p>
                  <strong class="adsimple-321164724">Name:</strong> CONSENT
                  <br />
                  <strong class="adsimple-321164724">Ablaufzeit:</strong> nach
                  19 Jahren
                  <br />
                  <strong class="adsimple-321164724">Verwendung:</strong> Das
                ...
                <p>
                  <strong class="adsimple-321164724">Name:</strong> NID
                  <br />
                  <strong class="adsimple-321164724">Ablaufzeit:</strong> nach 6
                  Monaten
                  <br />
                  <strong class="adsimple-321164724">Verwendung:</strong> NID
                  wird von Google verwendet, um Werbeanzeigen an Ihre
                  Google-Suche anzupassen. Mit Hilfe des Cookies „erinnert“ sich
                  Google an Ihre meist eingegebenen Suchanfragen oder Ihre
                  ...
                  <br />
                  <strong class="adsimple-321164724">Beispielwert:</strong>{" "}
                  0WmuWqy321164724zILzqV_nmt3sDXwPeM5Q
                </p>
                <p>
                  <strong class="adsimple-321164724">Name:</strong> DV
                  <br />
                  <strong class="adsimple-321164724">Ablaufzeit:</strong> nach
                  10 Minuten
                  <br />
                  <strong class="adsimple-321164724">Verwendung:</strong> Sobald
                  Sie das „Ich bin kein Roboter“-Häkchen angekreuzt haben, wird
                  dieses Cookie gesetzt. Das Cookie wird von Google Analytics
                  für personalisierte Werbung verwendet. DV sammelt
                  Informationen in anonymisierter Form und wird weiters benutzt,
                  um User-Unterscheidungen treffen zu können.
                  <br />
                  <strong class="adsimple-321164724">Beispielwert:</strong>{" "}
                  gEAABBCjJMXcI0dSAAAANbqc321164724
                  <p>
                  ...
                  <p>
                    ...
                    den Google-Server übertragen. Wo genau diese Daten
                    gespeichert werden, stellt Google, selbst nach wiederholtem
                    Nachfragen, nicht klar dar. Ohne eine Bestätigung von Google
                    erhalten zu haben, ist davon auszugehen, dass Daten wie
                    Mausinteraktion, Verweildauer auf der Webseite oder
                    Spracheinstellungen auf den europäischen oder amerikanischen
                    Google-Servern gespeichert werden. Die IP-Adresse, die Ihr
                    Browser an Google übermittelt, wird grundsätzlich nicht mit
                    anderen Google-Daten aus weiteren Google-Diensten
                    zusammengeführt. Wenn Sie allerdings während der Nutzung des
                    reCAPTCHA-Plug-ins bei Ihrem Google-Konto angemeldet sind,
                    werden die Daten zusammengeführt.
                    <strong class="adsimple-321164724"> </strong>Dafür gelten
                    die abweichenden Datenschutzbestimmungen der Firma Google.
                  </p>
                  <h3 class="adsimple-321164724">
                    Wie kann ich meine Daten löschen bzw. die Datenspeicherung
                    verhindern?
                  ...
                  <p>
                    Wenn Sie wollen, dass über Sie und über Ihr Verhalten keine
                    Daten an Google übermittelt werden, müssen Sie sich, bevor
                    Sie unsere Webseite besuchen bzw. die reCAPTCHA-Software
                    verwenden, bei Google vollkommen ausloggen und alle
                    Google-Cookies löschen. Grundsätzlich werden die Daten
                    sobald Sie unsere Seite aufrufen automatisch an Google
                    übermittelt. Um diese Daten wieder zu löschen, müssen Sie
                  ...
                  <p>
                    ...
                    einverstanden, dass Google LLC und deren Vertreter
                    automatisch Daten erheben, bearbeiten und nutzen.
                  </p>
                  <p>
                    Etwas mehr über reCAPTCHA erfahren Sie auf der
                    Webentwickler-Seite von Google auf{" "}
                    <a
                      class="adsimple-321164724"
                    ...
                    Datenspeicherung und datenschutzrelevanten Themen sucht man
                    auch dort vergeblich. Eine gute Übersicht über die
                    grundsätzliche Verwendung von Daten bei Google finden Sie in
                    der hauseigenen Datenschutzerklärung auf{" "}
                    <a
                      class="adsimple-321164724"
                      href="https://policies.google.com/privacy?hl=de&amp;tid=321164724"
                      target="_blank"
